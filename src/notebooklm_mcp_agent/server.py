...
from notebooklm_mcp_agent.backend.tasks import TaskStore
from notebooklm_mcp_agent.config import Settings
from notebooklm_mcp_agent.prompts import register_prompts
from notebooklm_mcp_agent.resources import register_artifact_resources, register_core_resources
from notebooklm_mcp_agent.tools import (
...
class _LazyNotebookLMBackend:
    ...
    def _resolve(self) -> Any:
        if self._backend is None:
            from notebooklm_mcp_agent.backend.client import NotebookLMBackend  # noqa: PLC0415
