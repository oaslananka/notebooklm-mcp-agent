...
from notebooklm_mcp_agent.tools.common import tool_public_name
from notebooklm_mcp_agent.tools.models import (
    ArtifactCancelInput,
    ArtifactDeleteInput,
...
OPENAPI_SCHEMA: dict[str, Any] = {
    ...
    "info": {
        ...
        "contact": {
            "name": "oaslananka",
            "url": "https://github.com/oaslananka/notebooklm-mcp-agent",
        },
    ...
    "components": {
        "securitySchemes": {
            "BearerAuth": {
                ...
                "scheme": "bearer",
                "description": (
                    "Bearer authentication. Set NOTEBOOKLM_MCP_BEARER_TOKEN on the server."
                ),
            }
        },
        "schemas": _schemas(),
