...
GITHUB_OAUTH_EXCHANGE_URL = "https://github.com/login/oauth/access_token"
USER_URL = "https://api.github.com/user"
SESSION_COOKIE = "NOTEBOOKLM_MCP_session"
...
class GitHubOAuthHandler:
    ...
    async def oauth_token(self, request: Request) -> Response:  # noqa: PLR0911
        ...
        try:
            ...
            return JSONResponse(
                {"error": "invalid_request", "message": "Invalid OAuth bearer request"},
                status_code=400,
            )
...
def _oauth_access_payload(*, access_token: str, scope: str, resource: str) -> dict[str, object]:
    ...
    payload["token_type"] = _oauth_bearer_scheme()
    return payload


def _oauth_registration_payload(
    *,
    client_id: str,
    issued_at: int,
    ...
    payload["token_endpoint_auth_method"] = _public_oauth_client_auth_method()
    return payload


def _oauth_bearer_scheme() -> str:
    return "Bearer"


def _public_oauth_client_auth_method() -> str:
    return "none"
